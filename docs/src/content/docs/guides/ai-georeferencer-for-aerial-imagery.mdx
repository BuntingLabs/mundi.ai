...
description: The AI Georeferencer can georectify aerial/satellite
  imagery automatically in under 15 seconds and return a GeoTIFF/GCPs.
---

import { LinkButton } from '@astrojs/starlight/components';

:::note[Now hosted at Bunting Labs]
The AI Georeferencer is now available at
[buntinglabs.com](https://buntinglabs.com/tools/ai-georeferencer) and is accessed
through your Bunting Labs account.
:::

The [AI Georeferencer](https://buntinglabs.com/tools/ai-georeferencer) takes
...
<div style={{ textAlign: 'center' }}>
  <LinkButton href="https://buntinglabs.com/tools/ai-georeferencer" icon="right-arrow">
...
:::note[Requires Bunting Labs Personal or Professional]
Running the AI Georeferencer is GPU-intensive, and as such, we require an
[active Bunting Labs Personal or Professional plan](https://buntinglabs.com/pricing)
to use it.
:::
